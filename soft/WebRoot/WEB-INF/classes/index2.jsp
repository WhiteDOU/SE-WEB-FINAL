      ...
      <div class="tip auto">
        <ul>
          ...
          <li><a href="competetion.html" class="pr">
            ...
            <li><a href="my-output.jsp" class="pr">
              <div class="tit">我的发布</div>
              <div class="entit">PERSONAL</div>
              <div class="pa tip_img_4"><img src="images/website.png" style="width :100%; height: 100%;"alt=""/></div></a></li>
        </ul>
      </div>
    </div>
    <div class="s_cen w">
        ...
        <div class="cen_two">
          ...
          <div class="cen_two_cen fl">
            ...
            <div class="s_news_bom">
              ...
              <div class="s_news_flag_desc">为深入开展科技创新活动，培养和锻炼学生运用所学解决实际问题的能力，同时选拔优秀学生参加2019年全国大学生数学建模竞赛及2019年国际（美国）大学生数学建模竞赛，经研究决定举办东北大学2019年“建龙钢铁”大学生数学建模竞赛。 <a href="">[ 查看详情 ]</a></div>
              <div class="s_news_bom_ul">
                <ul>
                  <li><a href="">关于举办2019东北大学大学生LabVIEW编程竞赛比赛通知...</a></li>
                  <li><a href="">关于举办东北大学2019年“建龙钢铁”大学生新媒体设计竞赛的通知...</a></li>
